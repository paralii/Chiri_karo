...
const GoogleIcon = (): JSX.Element => (
  <svg viewBox="0 0 48 48" className="h-4 w-4" aria-hidden="true">
    ...
    <path
      fill="#1976D2"
      d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.2 4.2-4.1 5.5l6.6 5.4C41.5 35.7 44 30.3 44 24c0-1.2-.1-2.4-.4-3.5z"
    />
  </svg>
);
...
export const GoogleButton = (): JSX.Element => {
  const handleClick = (): void => {
    window.location.href = `${appEnv.apiBaseUrl}/auth/google`;
  };
